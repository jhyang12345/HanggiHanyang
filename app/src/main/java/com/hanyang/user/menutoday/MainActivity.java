package com.hanyang.user.menutoday;
...
//        cafeteriaSelector.setVisibility(View.GONE);
        ...
        String currentItems = pref.getString("allitems", "[]");
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.hanyang.user.menutoday/http/host/path")
        );
    ...
    private class RetrieveURL extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... urls) {
            ...
            try {
                ...
                System.out.println("Link HTML: " + doc.html());
                //   GetMenus(menus);
